...
function create_config( )
  ...
  config = {
    ...
    vip_users = {}, --vip users
    sudo_users = {368305537,tonumber(our_id)},--Sudo users
    support_gp = {},--Support id
    moderation = {data = 'data/adv.json'},
    about_text = [[*IN THE NAME OF ALLAH*
This is an original bot and based on (DALAD Soures).
Copyright all right reserved and you must respect all laws.

Source:Seed Edited
Channel: @The_Dalton
Messenger: @Abol_Myth_Dalton
Creator: @Abol_Myth_Dalton
Version: Test For Beta
]],
    --Start rate:
    Group_rate = [[]],
    Supergroup_rate = [[]]
